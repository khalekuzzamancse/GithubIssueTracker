...
import feature_issuedetails.details.route.IssueDetailsViewData
...
/**
 * - one of the implementation of Controller for [IssueDetailsViewController]
 ...
 *  - Usages:
 *  - Client code/module should not create instance of it directly instead instance should be provide via factory method
 *   because client should depends on abstraction
 *
 */
internal class IssueDetailsViewControllerImpl : IssueDetailsViewController {
